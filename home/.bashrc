...
shopt -s histappend
shopt -s cmdhist # save multi-line as one command for tmux
...
# Personalization to git
parse_git_branch() {
  git branch 2>/dev/null | sed -e '/^[^*]/d' -e 's/* \(.*\)/(\1)/'
}
export PS1="\u@\h \[\e[32m\]\w \[\e[91m\]\$(parse_git_branch)\[\e[00m\]$ "

# Add alias to aws-vault
alias awsx='aws-vault exec'
alias awsxp='aws-vault exec $(aws-vault list | awk '\''NR > 2 && $3!= "-" && $1!= "-" {print $1}'\'')'

# Hooks direnv to shell
